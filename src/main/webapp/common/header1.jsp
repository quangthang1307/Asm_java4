                        ...
                        <c:when test="${not empty sessionScope.user}">
                            ...
                            <ul class="list-unstyled mb-0 d-flex align-items-center order-1 order-lg-2 nav-sidelinks">
                                ...
                                <li class="d-lg-none">
                                    <span class="nav-link text-body d-flex align-items-center cursor-pointer"
                                        ...
                                        aria-label="Toggle navigation"><i class="ri-menu-line ri-lg me-1"></i>
                                        Menu</span>
                                </li>
                                <!-- /Mobile Nav Toggler-->
                                ...
                                <li class="ms-1 d-inline-block position-relative dropdown-cart">
                                    ...
                                    <div class="cart-dropdown dropdown-menu">
                                        ...
                                        <div
                                            ...
                                            <i
                                                class="ri-close-circle-line text-muted ri-lg cursor-pointer btn-close-cart"></i>
                                        </div>
                                        <!-- / Cart Header-->
                                            ...
                                            <div class="row mx-0 py-4 g-0 border-bottom">
                                                <div class="col-2 position-relative">
                                                    <picture class="d-block ">
                                                        <img class="img-fluid"
                                                            ...
                                                            src="<c:url value='views/user/assets/images/products/product-cart-1.jpg' />">
                                                    </picture>
                                                </div>
                                                <div class="col-9 offset-1">
                                                    <div>
                                                        ...
                                                        <span
                                                            class="d-block text-muted fw-bolder text-uppercase fs-9">Size:
                                                            9 / Qty: 1</span>
                                                    </div>
                                            ...
                                            <div class="row mx-0 py-4 g-0 border-bottom">
                                                <div class="col-2 position-relative">
                                                    <picture class="d-block ">
                                                        <img class="img-fluid"
                                                            alt="HTML Bootstrap Template by Pixel Rocket"
                                                            src="<c:url value='views/user/assets/images/products/product-cart-2.jpg' />">
                                                    </picture>
                                                </div>
                                                <div class="col-9 offset-1">
                                                    <div>
                            ...
                            <div class="flex-shrink-0 collapse navbar-collapse navbar-collapse-light w-auto flex-grow-1 order-2 order-lg-1"
                                ...
                                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="sanpham" role="button">
                                            Sale
                                        </a>
                                    </li>
                                    <li class="nav-item dropdown">
                                ...
                                <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
                                    ...
                                    <li class="nav-item dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item" href="./forgotten-password.html">Forgotten
                                                    Password</a></li>
                                        </ul>
                                    </li>
                                </ul> <!-- / Menu-->
