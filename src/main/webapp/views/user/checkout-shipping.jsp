                    ...
                    <div class="pe-lg-5">
                        ...
                        <nav class="d-none d-md-block">
                            <ul class="list-unstyled d-flex justify-content-start mt-4 align-items-center fw-bolder small">
                                ...
                                <li class="me-4"><a class="nav-link-checkout "
                                        href="./Information.jsp">Information</a></li>
                            ...
                            <ul class="list-group mb-5 d-none d-lg-block rounded-0">
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    ...
                                    <a href="./Information.jsp" class="text-muted small" role="button">Change</a>
                                </li>
                            ...
                            <div class="pt-5 mt-5 pb-5 border-top d-flex flex-column flex-md-row justify-content-between align-items-center">
                              <a href="./Information.jsp" class="btn ps-md-0 btn-link fw-bolder w-100 w-md-auto mb-2 mb-md-0" role="button">Back to information</a>
