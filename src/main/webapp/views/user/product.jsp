            ...
            <div class="row g-9" data-sticky-container>
                ...
                <div class="col-12 col-md-6 col-xl-7">
                    <div class="row g-3" data-aos="fade-right">
                        <div class="col-12">
                            <picture>
                                <img class="img-fluid" alt="HTML Bootstrap Template by Pixel Rocket" data-zoomable src="<c:url value='views/user/assets/images/products/product-page-1.jpeg' />" >
                            </picture>
                        </div>
                        <div class="col-12">
                            <picture>
                                <img class="img-fluid" data-zoomable alt="HTML Bootstrap Template by Pixel Rocket" src="<c:url value='views/user/assets/images/products/product-page-2.jpeg' />" >
                            </picture>
                        </div>
                        <div class="col-12">
                            <picture>
                                <img class="img-fluid" data-zoomable alt="HTML Bootstrap Template by Pixel Rocket" src="<c:url value='views/user/assets/images/products/product-page-3.jpeg' />" >
                            </picture>
                        </div>
                        <div class="col-12">
                            <picture>
                                <img class="img-fluid" data-zoomable alt="HTML Bootstrap Template by Pixel Rocket" src="<c:url value='views/user/assets/images/products/product-page-4.jpeg' />" >
                            </picture>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="sticky-top top-5">
                        <div class="pb-3" data-aos="fade-in">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mt-4 d-flex justify-content-start flex-wrap align-items-start">
                                    <picture class="me-2">
                                        <img class="f-w-24 p-2 bg-light border-bottom border-dark border-2 cursor-pointer" alt="HTML Bootstrap Template by Pixel Rocket" src="<c:url value='views/user/assets/images/products/product-page-thumb-1.jpeg' />" >
                                    </picture>
                                    <picture>
                                        <img class="f-w-24 p-2 bg-light cursor-pointer" alt="HTML Bootstrap Template by Pixel Rocket" src="<c:url value='views/user/assets/images/products/product-page-thumb-2.jpeg' />" >
                                    </picture>
                                </div>
                            </div>
                              ...
                              <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                                  <div class="card-img position-relative">
                                      ...
                                      <picture class="position-relative overflow-hidden d-block bg-light">
                                          <img class="w-100 img-fluid position-relative z-index-10" title="" src="<c:url value='views/user/assets/images/products/product-1.jpg' />" alt="">
                                      </picture>
                            ...
                            <div class="swiper-slide">
                              ...
                              <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                                  <div class="card-img position-relative">
                                      ...
                                      <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                      <picture class="position-relative overflow-hidden d-block bg-light">
                                          <img class="w-100 img-fluid position-relative z-index-10" title="" src="<c:url value='views/user/assets/images/products/product-2.jpg' />" alt="">
                                      </picture>
                                          <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                              <button class="btn btn-quick-add"><i class="ri-add-line me-2"></i> Quick Add</button>
                                          </div>
                            ...
                            <div class="swiper-slide">
                              ...
                              <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                                  <div class="card-img position-relative">
                                      ...
                                      <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                      <picture class="position-relative overflow-hidden d-block bg-light">
                                          <img class="w-100 img-fluid position-relative z-index-10" title="" src="<c:url value='views/user/assets/images/products/product-3.jpg' />" alt="">
                                      </picture>
                                  </div>
                                  <div class="card-body px-0">
                            ...
                            <div class="swiper-slide">
                              ...
                              <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                                  <div class="card-img position-relative">
                                      ...
                                      <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                      <picture class="position-relative overflow-hidden d-block bg-light">
                                          <img class="w-100 img-fluid position-relative z-index-10" title="" src=" <c:url value='views/user/assets/images/products/product-4.jpg' />" alt="">
                                      </picture>
                                          <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                              <button class="btn btn-quick-add"><i class="ri-add-line me-2"></i> Quick Add</button>
                                          </div>
                            ...
                            <div class="swiper-slide">
                              ...
                              <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                                  <div class="card-img position-relative">
                                      ...
                                      <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                      <picture class="position-relative overflow-hidden d-block bg-light">
                                          <img class="w-100 img-fluid position-relative z-index-10" title="" src="<c:url value='views/user/assets/images/products/product-5.jpg' />" alt="">
                                      </picture>
                                          <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                              <button class="btn btn-quick-add"><i class="ri-add-line me-2"></i> Quick Add</button>
                                          </div>
                            ...
                            <div class="swiper-slide">
                              ...
                              <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                                  <div class="card-img position-relative">
                                      ...
                                      <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                      <picture class="position-relative overflow-hidden d-block bg-light">
                                          <img class="w-100 img-fluid position-relative z-index-10" title="" src="<c:url value='views/user/assets/images/products/product-6.jpg' />" alt="">
                                      </picture>
                                          <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                              <button class="btn btn-quick-add"><i class="ri-add-line me-2"></i> Quick Add</button>
                                          </div>
                            ...
                            <div class="swiper-slide">
                              ...
                              <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                                  <div class="card-img position-relative">
                                      ...
                                      <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                      <picture class="position-relative overflow-hidden d-block bg-light">
                                          <img class="w-100 img-fluid position-relative z-index-10" title="" src="<c:url value='views/user/assets/images/products/product-7.jpg' />" alt="">
                                      </picture>
                                          <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                              <button class="btn btn-quick-add"><i class="ri-add-line me-2"></i> Quick Add</button>
                                          </div>
                            ...
                            <div class="swiper-slide">
                              ...
                              <div class="card border border-transparent position-relative overflow-hidden h-100 transparent">
                                  <div class="card-img position-relative">
                                      ...
                                      <span class="position-absolute top-0 end-0 p-2 z-index-20 text-muted"><i class="ri-heart-line"></i></span>
                                      <picture class="position-relative overflow-hidden d-block bg-light">
                                          <img class="w-100 img-fluid position-relative z-index-10" title="" src="<c:url value='views/user/assets/images/products/product-8.jpg' />" alt="">
                                      </picture>
                                          <div class="position-absolute start-0 bottom-0 end-0 z-index-20 p-2">
                                              <button class="btn btn-quick-add"><i class="ri-add-line me-2"></i> Quick Add</button>
                                          </div>
