            ...
            <div class="shadow-xl p-4 p-lg-5 bg-white">
                ...
                <form id="register-form" action="register" method="POST">
                    <div class="form-group">
                      <label class="form-label" for="register-fname">Full name</label>
                    ...
                    <div class="form-group">
                      ...
                      <input type="password" class="form-control" id="register-password" name="cfmpassword" placeholder="Confirm your password">
                    </div>
